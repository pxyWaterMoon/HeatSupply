...
def test(net, loss_func, dataloader):
    ...
    print("Test error:", np.sqrt(test_loss / test_num))
...
if __name__=="__main__":
    ...
    train(net,loss_func,optimizer,scheduler,200,train_data_l, test_data_l)
